...
export default function PartnersFeatured() {
    const t = useTranslations('partners.featured');
    
    const featuredPartner = {
        name: t('partner.name'),
        description: t('partner.description'),
        logo: t('partner.logo'),
        website: t('partner.website'),
        rating: 5,
        services: t.raw('partner.services'),
        benefits: t.raw('partner.benefits')
    };
                        ...
                        <div className="md:flex">
                            <div className="md:w-1/3 bg-gradient-to-br from-purple-100 to-purple-50 p-6 md:p-8 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-gray-500">{t('partner.featured_badge')}</p>
                                </div>
                            </div>
                            ...
                            <div className="md:w-2/3 p-6 md:p-8">
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
                                    ...
                                    <Link 
                                        ...
                                        itemProp="url"
                                        aria-label={t('partner.visit_website_aria', { name: featuredPartner.name })}
                                    >
                                        <span>{t('partner.visit_button')}</span>
                                ...
                                <p className="text-gray-600 mb-6 text-sm md:text-base" itemProp="description">
                                    {t('partner.detailed_description')}
                                </p>
                                
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <p className="font-medium text-gray-900 mb-1">{t('partner.services_title')}</p>
                                    ...
                                    <div>
                                        <p className="font-medium text-gray-900 mb-1">{t('partner.benefits_title')}</p>
                                        <ul className="text-gray-600 space-y-1">
