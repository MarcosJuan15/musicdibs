...
import { Shield, FileText, User, ArrowLeft, Info, CheckCircle, Lock, Award, Clock } from "lucide-react";
...
export default function VerifyContent() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        window.open('https://identity.icommunitylabs.com/identification/wzd_idn_e96GSKpnkrdtdRtELx3Z2D', '_blank');
    };
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <div className="space-y-4 text-gray-700">
                                    ...
                                    <p className="leading-relaxed">
                                        ...
                                        guardadas de manera segura en blockchain.
                                    </p>
                                </div>
                            </div>
                        </section>
                    ...
                    <div className="space-y-6">
                        ...
                        <section aria-labelledby="benefits-title">
                            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl p-6 text-white">
                                <h2 id="benefits-title" className="text-lg font-semibold mb-4 flex items-center">
                        ...
                        <section aria-labelledby="verification-cta-title">
                            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-lg text-center hover:shadow-xl transition-shadow">
                                ...
                                <button 
                                    ...
                                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl"
        ...
        <div className="space-y-6">
            ...
            <div>
                <button 
                    ...
                    className="flex items-center space-x-2 text-blue-600 hover:text-blue-700 mb-4 transition-colors group"
                    ...
                    <section aria-labelledby="document-form-title">
                        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                {/* Tipo de documento */}
                                <div>
                                    <label htmlFor="documentType" className="block text-sm font-medium text-gray-700 mb-3 flex items-center">
                                ...
                                <div>
                                    <label htmlFor="documentNumber" className="block text-sm font-medium text-gray-700 mb-3 flex items-center">
                                        <FileText className="mr-2 flex-shrink-0" size={16} />
                                        Número del documento
                                    </label>
                                    <input 
